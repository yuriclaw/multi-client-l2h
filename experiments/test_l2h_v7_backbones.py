"""
Two-Stage L2H v7: Backbone Comparison + New Datasets
=====================================================
Server backbones: ResNet-50, DINOv2-B/14, CLIP-ViT-B/16
Datasets: CIFAR-100, Flowers102, OxfordIIITPet, Food101, Caltech256
Methods: L2H(c1=1), Gatekeeper(α=0.8), ConfThresh, Random
Client: AlexNet, Rejector: AlexNet-style + client hidden
"""
...
class ClientAlexNet(nn.Module):
    ...
    def forward(self, x):
        return self.fc2(self.fc1(self.features(x)))
...
def main():
    ...
    print(f"\n[2] Training client AlexNet ({CLIENT_EPOCHS}ep)...")
    client_models = {}
