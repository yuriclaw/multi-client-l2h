"""
Two-Stage L2H v5: Corrected Loss Implementations
==================================================
Key changes from v4:
1. GK: finetune client fc2 (last layer) with Gatekeeper loss, defer by confidence
2. Mozannar/OvA: extend client last layer to K+1, defer = class K+1
3. L2H: separate rejector (AlexNet on raw x + hidden), same as v4
4. Stage 2 jointly trains rejector/client-fc2 AND server head

Setup unchanged: AlexNet client, ResNet-50 server, 5 heterogeneous clients
"""
...
def main():
    t_start = time.time()
    print("=" * 90)
    print("L2H v5: Corrected Loss Implementations + Joint Training")
    print("=" * 90)
    ...
    method_names = ['L2H(c1=1)', 'GK(α=0.8)', 'Mozannar', 'OvA', 'ConfTh', 'Random']
